...
async function openConfirmationCard(id){
  try{
    ...
    ctx.fillStyle='#555';ctx.font='700 15px Arial';ctx.fillText('Generated from Coach Kyle Booking System',72,1288);ctx.textAlign='right';ctx.fillStyle='#666';ctx.font='700 13px Arial';ctx.fillText('Powered by XBALANCED DIGITAL SOLUTIONS',1008,1312);ctx.textAlign='left';
